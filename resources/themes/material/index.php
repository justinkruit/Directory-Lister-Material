...
<html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo THEMEPATH; ?>/img/folder2.png">
		...
		<link href="//cdn.materialdesignicons.com/1.6.50/css/materialdesignicons.min.css" media="all" rel="stylesheet" type="text/css" />
...
<br>
            <div id="page-content" class="container">
                ...
                <div id="directory-list-header" class="<? echo $textcolor; ?>">
                    <div class="row">
                ...
                <ul id="directory-listing" class="nav nav-pills nav-stacked">
					...
					<?php include('fileIcon.php'); ?>
                        <li data-name="<?php echo $name; ?>" data-href="<?php echo $fileInfo['url_path']; ?>">
                            <a href="<?php echo $fileInfo['url_path']; ?>" class="<? echo $textcolor; ?> clearfix" data-name="<?php echo $name; ?>">


                                <div class="row">
                                    <span class="file-name col m6 s9">
                                        <i class="<? echo $themeiconsleft ? $color.'-text' : ''; ?> mdi mdi-<?php echo $useIcon; ?>" style="font-size: 20px;"></i>
                                        <?php echo $name; ?>
                                    </span>
                            ...
                            <?php if (is_file($fileInfo['file_path']) & $showinfobutton): ?>
                                ...
                                <a href="javascript:void(0)" class="<? echo $textcolor; ?> file-info-button">
                                    <i class="<? echo $themeiconsright ? $color.'-text' : ''; ?> material-icons" style="font-size: 20px">info</i>
                                </a>
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($lister->containsIndex($fileInfo['file_path'])): ?>
                                    ...
                                    <a href="<?php echo $fileInfo['file_path']; ?>" class="<? echo $textcolor; ?> web-link-button" <?php if($lister->externalLinksNewWindow()): ?>target="_blank"<?php endif; ?>>
                                        <i class="<? echo $themeiconsright ? $color.'-text' : ''; ?> material-icons" style="font-size: 20px">launch</i>
                                    </a>
        ...
        <?php file_exists('footer.php') ? include('footer.php') : include($lister->getThemePath(true) . "/default_footer.php"); ?>
          ...
          <!-- Modal Structure -->
  <div id="file-info-modal" class="modal <? echo $lighttheme ? '' : $background.' '.$textcolor; ?>">
    ...
    <div class="modal-footer <? echo $lighttheme ? '' : $background.' '.$textcolor; ?>">
      <a href="#!" class="<? echo $lighttheme ? '' : $textcolor.' waves-light'; ?> modal-action modal-close waves-effect btn-flat">Agree</a>
    </div>
  </div>
